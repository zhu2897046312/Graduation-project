<template>
  <BasicModal title="商品属性" @on-ok="handleSubmit" @on-close="handleClose" ref="modalRef">
...
const handleOpen = (e: any) => {
  loadingTask(async () => {
    ...
    formState.value = await api.shop.prodAttributes.info( e.id)
...
const handleSubmit = async () => {
  ...
  loadingTask(async () => {
    await api.shop.prodAttributes.modify(formState.value)
