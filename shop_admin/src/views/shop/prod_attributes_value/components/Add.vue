<template>
  <BasicModal title="新增商品属性值" @on-ok="handleSubmit" @on-close="handleClose" ref="modalRef">
...
let prod_attributes_id = 0

const handleOpen = (e: any) => {
  prod_attributes_id = e.prod_attributes_id
  console.log(e, prod_attributes_id)
  loadingTask(async () => {
...
const handleSubmit = async () => {
  ...
  loadingTask(async () => {
    const payload = Object.assign(formState.value, {prod_attributes_id})
    await api.shop.prodAttributesValue.create(payload)
