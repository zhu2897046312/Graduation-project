...
type ClientSpMarketSettingHandler struct {
...
func NewClientSpMarketSettingHandler(
	categoryService *service.SpCategoryService,
	productService *service.SpProductService,
) *ClientSpMarketSettingHandler {
	return &ClientSpMarketSettingHandler{
...
func (h *ClientSpMarketSettingHandler) GetBreadcrumb(c *gin.Context) {
...
func (h *ClientSpMarketSettingHandler) GetFreight(c *gin.Context) {
	utils.Success(c, "20")
}
