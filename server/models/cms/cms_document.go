...
type CmsDocument struct {
	...
	LinkType          int8        `gorm:"not null;default:0" json:"link_type"`
	DocumentType      int8        `gorm:"not null;default:0" json:"document_type"`
	...
	LikeNum           int         `gorm:"not null;default:0" json:"like_num"`
