...
type SpOrder struct {
	...
	PayType          common.MyType  `gorm:"not null;default:0" json:"pay_type"`
	SourceType       common.MyType  `gorm:"not null;default:0" json:"source_type"`
	State            common.MyState `gorm:"not null;default:0" json:"state"`
	DisputeStatus    common.MyState `gorm:"not null;default:0" json:"dispute_status"`
