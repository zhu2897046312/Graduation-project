...
func (s *SpProductPropertyService) GetPropertiesByProductID(productID uint) ([]sp.SpProductProperty, error) {
	if productID == 0 {
...
func (s *SpProductPropertyService) DeletePropertiesByProductID(productID uint) error {
	if productID == 0 {
