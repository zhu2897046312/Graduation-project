...
<template>
  <div class="h-full">
    ...
    <div v-if="breadcrumb && breadcrumb.length > 0" class="container my-3 py-4 bg-[#f6f6f8] text-[#878787]">
     <NBreadcrumb>
      <NBreadcrumbItem>
    ...
    <footer class=" flex flex-col justify-center items-center h-48 bg-[#f6f6f8] text-[#878787] pd-4 mt-10 text-lg">
        ...
        <div v-if="footer_list && footer_list.length > 0" class="footer-links grid grid-cols-2 gap-1 w-full max-w-md mx-auto">
        <NuxtLink 
